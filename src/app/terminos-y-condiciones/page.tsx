  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="space-y-10 text-sm leading-relaxed text-text-main">
        <section>
          <h2 className="mb-3 text-lg font-semibold">PRIMERO: DEFINICIONES</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">SEGUNDO: SERVICIOS</h2>
          <h3 className="mb-2 mt-6 text-base font-semibold">2.1. Servicios ofrecidos por AGORA</h3>
          ...
          <h3 className="mb-2 mt-6 text-base font-semibold">2.1.1. Servicio de Marketplace de Espacios</h3>
          ...
          <h3 className="mb-2 mt-6 text-base font-semibold">2.1.2. Condiciones generales del Servicio de Marketplace de Espacios</h3>
          ...
          <h3 className="mb-2 mt-6 text-base font-semibold">2.1.3. Tarifa de Servicio al Usuario</h3>
          ...
          <h3 className="mb-2 mt-6 text-base font-semibold">2.1.4. Acceso al Portal del Anfitrión</h3>
          ...
          <h3 className="mb-2 mt-6 text-base font-semibold">2.1.5. Servicio de Pago Online</h3>
          ...
          <h3 className="mb-2 mt-6 text-base font-semibold">2.2. Servicios Complementarios</h3>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">TERCERO: PRECIO DEL SERVICIO PARA EL CLIENTE</h2>
          <h3 className="mb-2 mt-6 text-base font-semibold">3.1. Gratuidad del servicio de marketplace para el Cliente</h3>
          ...
          <h3 className="mb-2 mt-6 text-base font-semibold">3.2. Tarifa de Incorporación (Set-Up Fee)</h3>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">CUARTO: FACTURACIÓN, LIQUIDACIÓN Y OBLIGACIONES TRIBUTARIAS</h2>
          <h3 className="mb-2 mt-6 text-base font-semibold">4.1. Documentos tributarios y responsabilidades de cada Parte</h3>
          ...
          <h3 className="mb-2 mt-6 text-base font-semibold">4.2. Liquidación semanal</h3>
          ...
          <h3 className="mb-2 mt-6 text-base font-semibold">4.3. Adeudos y descuentos en Liquidación</h3>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">QUINTO: POLÍTICA DE CANCELACIONES Y NO-SHOW</h2>
          <h3 className="mb-2 mt-6 text-base font-semibold">5.1. Política base de AGORA</h3>
          ...
          <h3 className="mb-2 mt-6 text-base font-semibold">5.2. Política personalizada del Cliente</h3>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">SEXTO: CONFIDENCIALIDAD Y TRATAMIENTO DE DATOS</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">SÉPTIMO: PROPIEDAD INTELECTUAL</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">OCTAVO: ANTICORRUPCIÓN Y ANTISOBORNO</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">NOVENO: RESPONSABILIDAD E INDEMNIDAD</h2>
          <h3 className="mb-2 mt-6 text-base font-semibold">9.1. Responsabilidad</h3>
          ...
          <h3 className="mb-2 mt-6 text-base font-semibold">9.2. Indemnidad</h3>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">DÉCIMO: PLAZO</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">DÉCIMO PRIMERO: INCUMPLIMIENTO Y TERMINACIÓN</h2>
          <h3 className="mb-2 mt-6 text-base font-semibold">11.1. Mora automática</h3>
          ...
          <h3 className="mb-2 mt-6 text-base font-semibold">11.2. Suspensión en la ejecución de los servicios</h3>
          ...
          <h3 className="mb-2 mt-6 text-base font-semibold">11.3. Terminación por incumplimiento</h3>
          ...
          <h3 className="mb-2 mt-6 text-base font-semibold">11.4. Terminación unilateral</h3>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">DÉCIMO SEGUNDO: NATURALEZA DE LA RELACIÓN</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">DÉCIMO TERCERO: MODIFICACIONES AL ACUERDO</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">DÉCIMO CUARTO: INACCIÓN</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">DÉCIMO QUINTO: CESIÓN DE CRÉDITOS Y CESIÓN DE ACUERDO</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">DÉCIMO SEXTO: NULIDAD PARCIAL</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">DÉCIMO SÉPTIMO: IMPUESTOS</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">DÉCIMO OCTAVO: LEY APLICABLE Y ARBITRAJE</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">DÉCIMO NOVENO: DOMICILIOS Y NOTIFICACIONES</h2>
